...
def test_get_api_key_for_invalid_key(email=valid_email, password='123455'):
...
def test_get_api_key_for_invalid_user(email='kottor@mail.ru', password=valid_password):
